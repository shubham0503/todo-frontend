                ...
                <v-form name="form">
                  <v-card-text>
                    <ValidationProvider name="email" rules="required|email">
                      <v-text-field slot-scope="{ errors, valid }" v-model="user.email" :error-messages="errors"
                        :success="valid" label="E-mail" required prepend-icon="mdi-account"></v-text-field>
                    </ValidationProvider>

                    <ValidationProvider name="password" rules="required">
                      <v-text-field slot-scope="{ errors, valid }" v-model="user.password" :error-messages="errors"
                        :success="valid" label="Password" required type="password" prepend-icon="mdi-lock" />
                    </ValidationProvider>
                  </v-card-text>
                  <v-card-actions>
